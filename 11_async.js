...
const usingAwait = async (callback) => { await sleep(2000); callback()};
...
//console.log("Axios 1");
//apiResponse("http://jsonplaceholder.typicode.com/todos/1").then((body) => console.log("FIN " + JSON.stringify(body)));
//console.log("Axios 2");
